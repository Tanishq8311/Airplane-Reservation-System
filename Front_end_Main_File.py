...
mydb=mysql.connector.connect(host="localhost",port='3306',user="root",passwd="hello",database="myairport")
...
#
    ...
    print("1.Search Flight Details(Available Services:Jaipur,Delhi,Mumbai,Kolkata)")
